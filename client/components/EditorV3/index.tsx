                ...
                <div className="h-full w-full">
                    <div className="m-4 mb-0">
                        <input
                            ...
                            className="mb-1 w-full rounded-md border-none bg-white py-2 px-3 text-4xl font-black text-indigo-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0"
                        />
                    </div>
                </div>
